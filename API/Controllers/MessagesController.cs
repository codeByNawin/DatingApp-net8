...
[Authorize]
public class MessagesController(IMessageRepository messageRepository, IUserRespository userRespository, 
    IMapper mapper) : BaseApiController
{
    ...
    public async Task<ActionResult<IEnumerable<MessageDto>>> GetMessageThread(string username)
    {
        ...
        return Ok(await messageRepository.GetMessageThread(currenUsername, username));
    }
